...
def main():
    ...
    # save results
    df_results.to_csv('data/glm_bootstrap_v2.csv', index=False)

    # compute significance
    df_glm = pd.read_csv("/data/glm_results.csv")
    df_bootstrap = pd.read_csv('/data/glm_bootstrap_v2.csv')
    p_values = []
    ...
    df_glm.to_csv('data/glm_stats_v2.csv', index=False)
